			...
			<tbody>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<input type="radio" name="isDisplay" value="1" <c:if test="${brand.isDisplay==1}">checked="checked"</c:if>>是</input>
						<input type="radio" name="isDisplay" value="0" <c:if test="${brand.isDisplay==0}">checked="checked"</c:if>>不是</input>
					</td>
				</tr>
			</tbody>
			<tbody>
