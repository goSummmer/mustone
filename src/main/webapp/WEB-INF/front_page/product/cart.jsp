...
<c:if test="${fn:length(buyCart.itemList)!=0 }">
<div class="w ofc case">
	<div class="confirm">
		...
		<div class="ofc pb40">
			...
			<tbody>
				<c:forEach items="${buyCart.itemList }" var="item">
				<tr>
					<td class="nwp pic">
						<ul class="uls">
							<li>
			...
			<div class="page">
				<span class="l">
					<input type="button" onclick="window.open('/product/detail.shtml?id=275')" class="hand btn100x26c" title="继续购物" value="继续购物">
